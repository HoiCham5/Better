...
const CommentSection = ({ productId }) => {
  ...
  const fetchComments = async () => {
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL || 'https://better-grg6.onrender.com'}/api/reviews/${productId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_API_URL || 'https://better-grg6.onrender.com'}/api/reviews`, {
        method: 'POST',
        headers: {
